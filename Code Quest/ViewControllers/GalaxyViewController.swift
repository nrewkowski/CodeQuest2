...
class GalaxyViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if let savedLevels = loadLevels() {
            ...
            planet1Stars.text = "Stars Received: "+String(planet1StarsGotten)
            planet2Stars.text = "Stars Received: "+String(planet2StarsGotten)
            planet3Stars.text = "Stars Received: "+String(planet3StarsGotten)
