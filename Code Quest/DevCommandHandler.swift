...
class DevCommandHandler : CommandHandler {
	
	
	
	override init(level : inout [[gameCell]], playerLoc : inout (Int, Int), goalLoc : inout (Int, Int), myGameScene: GameScene) {
		//TODO: Fix gamescene bodge
		super.init(level: &level, playerLoc: &playerLoc, goalLoc: &goalLoc, myGameScene: myGameScene)
		self.level = level
	...
	*/
	override func handleCmd(input: Int) -> (Bool, Bool) {
	...
	*/
	override func newCoordsFromCommand(input: Int) -> (Int, Int) {
	...
	*/
	override func moveCmd(input: Int) -> Bool {
	...
	*/
	override func setPlayerLoc(newCoords: (Int, Int)) -> Bool {
	...
	override func resetGoal(coords: (Int, Int)) -> Bool {
