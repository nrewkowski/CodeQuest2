//
//  DevLevelTableViewController.swift
//  Code Quest
//
//  Created by Nicholas Rewkowski on 3/24/17.
...
class DevLevelTableViewController: LevelTableViewController {
	...
	override func loadLevels() -> [Level]? {
	...
	override func loadDefaultLevels() {
	...
	override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
		let cellIdentifier = "DevLevelTableViewCell"
		let cell = tableView.dequeueReusableCell(withIdentifier: cellIdentifier, for: indexPath) as! DevLevelTableViewCell
	...
	override func LevelFromMaze(maze: Maze, name: String, tutorial: String) -> Level {
	...
	override func makeMazeLevel(name: String, tutorial:String) -> Level {
	...
	*/
	...
	override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
		if segue.identifier == "DevShowStage" {
			let levelViewController = segue.destination as! LevelViewController
			if let selectedLevelCell = sender as? DevLevelTableViewCell {
