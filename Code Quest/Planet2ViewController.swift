...
class Planet2ViewController: UIViewController, PlanetViewController {
	...
	func loadDefaultLevels() {
		...
		let level4 = Level(name: "Level 2-1", data: data4, startingLoc:(0,0), goalLoc:(3,1), tutorial:"An Alien needs your help! We cannot leave without the Alien! Make sure you pick them up on the way to the ship!", starsGotten: 0, parNumMoves: 4,numOfMovesRequiredPerStar: [6,4,3])
		...
		let level5 = Level(name: "Level 2-2", data: data5, startingLoc: (0, 0), goalLoc: (3, 1), tutorial: "Another Alien is lost and needs your help!", starsGotten: 0, parNumMoves: 4,numOfMovesRequiredPerStar: [6,4,3])
		
		let data6 = [[1,2,1,1,1],
		             [1,1,1,2,2],
		             [2,2,1,1,4]]
		
		let level6 = Level(name: "Level 2-3", data: data6, startingLoc: (0, 0), goalLoc: (4, 0), tutorial: "Another Alien needs your help! You will have to backtrack after picking up the Alien!", starsGotten: 0, parNumMoves: 4,numOfMovesRequiredPerStar: [6,4,3])
		
		

		levels += [level4, level5, level6]
		saveLevels()
	}
